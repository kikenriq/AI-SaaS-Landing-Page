...
export const Hero = () => {
  ...
  >
    ...
    className='absolute h-[344px] w-[344px] md:h-[580px] md:w-[580px] border border-white opacity-20 rounded-full top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2'>
      ...
      <div className='absolute h-5 w-5 left-full border boder-white rounded-full top-1/2 -translate-x-1/2 -translate-y-1/2 inline-flex items-center justify-center'>
    ...
    className='absolute h-[444px] w-[444px] md:h-[780px] md:w-[780px] border border-white/20 border-dashed rounded-full top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2'></motion.div>
    <motion.div 
      style={{
        translateY: '-50%',
        translateX: '-50%',
